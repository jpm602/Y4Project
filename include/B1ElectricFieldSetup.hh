...
#ifndef B1ElectricFieldSetup_h
#define B1ElectricFieldSetup_h 1
...
class B1ElectricFieldSetup
{
public:
  B1ElectricFieldSetup(G4ThreeVector);  //  The value of the field
  B1ElectricFieldSetup();               //  A zero field - true value set later

  virtual ~B1ElectricFieldSetup();
